...
class ClientController extends AbstractController
{
     ...
     */
    public function index(Request $request, DataTableFactory $dataTableFactory, ClientRepository $clientRepository): Response
    {
        ...
        foreach ($clients as $client) {
            $results[] = [
                ...
                'cp' => $client->getZipCode(),
                'city' => $client->getCity(),
                'phone' => $client->getPhoneNumber1(),
                'email' => $client->getEmail(),
                'refs'  => count($client->getStudies())
            ];
        }
